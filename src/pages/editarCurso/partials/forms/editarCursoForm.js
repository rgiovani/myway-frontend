...
export default function EditarCursoForm({ onSubmit, submitting, formData }) {
  ...
  useEffect(() => {
    ...
    formik.setFieldValue('studentPrerequisites', formData.studentPrerequisites)
    formik.setFieldValue('studentTargets', formData.studentTargets)
    formik.setFieldValue('goals', formData.goals)
    formik.setFieldValue('studentTargets', formData.studentTargets)
    formik.setFieldValue('level', formData.level)
    formik.setFieldValue('language', formData.language[0].name)
    formik.setFieldValue('courseImage', formData.courseImage)
    formik.setFieldValue('totalScore', formData.totalScore)
    formik.setFieldValue('numberOfRatings', formData.numberOfRatings)
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <div className={classes.file}>
        <p className='image-title'>Alterar imagem do curso (Não obrigatório)</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '3rem' }}>
        ...
        <Button variant="contained" color="primary" disableElevation type="submit">
          {submitting ? 'Salvando...' : 'Editar curso'}
        </Button>
      </div>
    </form>
  )
